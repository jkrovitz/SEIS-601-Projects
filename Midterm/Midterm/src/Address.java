 ...
 *
 * Represents a single address. I pulled this class  directly
 * from my SEIS-601 Homework 5 assignment.
 */
public class Address {
	...
	public String toString() {
		...
		if (this.addressLine2.equals(" ")  || this.addressLine2.equals("") || this.addressLine2 == null) {
			addressString = this.addressLine1 + "\n" + this.city + ", " + this.state + " " + this.zip;
		}
		else {
			addressString = this.addressLine1 + ", " + this.addressLine2 + "\n" + this.city + ", " + this.state + " " + this.zip;
		}
