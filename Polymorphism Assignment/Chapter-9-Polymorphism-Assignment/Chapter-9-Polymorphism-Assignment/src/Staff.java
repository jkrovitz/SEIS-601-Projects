...
public class Staff {
	...
	public Staff() {
		...
		staffList[4] = new Volunteer("Adriana", "987 Babe Blvd.", "555-8374");
		staffList[5] = new Volunteer("Benny", "321 Dud Lane", "555-7287");
	...
	public void payday() {
		double amount;
		NumberFormat fmtAmount = NumberFormat.getCurrencyInstance();
		...
		for (int count = 0; count< staffList.length; count++) {
			...
			if(amount == 0.0) {
				...
				double taxesAmount =  ITaxCalculator.calculateTax(amount, 0.15);
				System.out.println("\nTotal Gross Pay: " + fmtAmount.format(amount)
				+ "\nAmount of Taxes: " + fmtAmount.format(taxesAmount) +
						"\nTake Home Pay: " + fmtAmount.format(amount - taxesAmount));
			}
			System.out.println("------------------------------------------");
		}
